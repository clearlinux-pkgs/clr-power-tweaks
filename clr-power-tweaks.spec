...
Version  : 233
Release  : 166
URL      : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/233.tar.gz
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/233.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-233
cd %{_builddir}/clr-power-tweaks-233
pushd ..
cp -a clr-power-tweaks-233 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709653990
