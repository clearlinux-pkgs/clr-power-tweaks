...
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/225.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-225
cd %{_builddir}/clr-power-tweaks-225
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681342309
