...
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/223.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-223
cd %{_builddir}/clr-power-tweaks-223
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677778590
