...
Version  : 209
Release  : 137
URL      : https://github.com/clearlinux/clr-power-tweaks/releases/download/209/clr-power-tweaks-209.tar.gz
Source0  : https://github.com/clearlinux/clr-power-tweaks/releases/download/209/clr-power-tweaks-209.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-209
cd %{_builddir}/clr-power-tweaks-209
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586283614
...
cp %{_builddir}/clr-power-tweaks-209/COPYING %{buildroot}/usr/share/package-licenses/clr-power-tweaks/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
