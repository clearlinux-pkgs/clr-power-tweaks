...
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/231.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-231
cd %{_builddir}/clr-power-tweaks-231
pushd ..
cp -a clr-power-tweaks-231 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704467423
