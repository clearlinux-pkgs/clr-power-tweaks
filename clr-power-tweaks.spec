...
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/224.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-224
cd %{_builddir}/clr-power-tweaks-224
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678227418
