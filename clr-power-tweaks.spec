...
Version  : 178
Release  : 116
URL      : http://localhost/cgit/projects/clr-power-tweaks/snapshot/clr-power-tweaks-178.tar.xz
Source0  : http://localhost/cgit/projects/clr-power-tweaks/snapshot/clr-power-tweaks-178.tar.xz
...
%prep
%setup -q -n clr-power-tweaks-178
...
export LANG=C
export SOURCE_DATE_EPOCH=1543990454
...
mkdir %{buildroot}/usr/lib/systemd/system/timer.target.wants
ln -s ../clr-power.timer %{buildroot}/usr/lib/systemd/system/timer.target.wants/clr-power.timer
## install_append end
...
%files autostart
%defattr(-,root,root,-)
/usr/lib/systemd/system/timer.target.wants/clr-power.timer
...
%files services
%defattr(-,root,root,-)
%exclude /usr/lib/systemd/system/timer.target.wants/clr-power.timer
