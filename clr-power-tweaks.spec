...
Version  : 210
Release  : 138
URL      : https://github.com/clearlinux/clr-power-tweaks/releases/download/210/clr-power-tweaks-210.tar.gz
Source0  : https://github.com/clearlinux/clr-power-tweaks/releases/download/210/clr-power-tweaks-210.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-210
cd %{_builddir}/clr-power-tweaks-210
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586466159
...
cp %{_builddir}/clr-power-tweaks-210/COPYING %{buildroot}/usr/share/package-licenses/clr-power-tweaks/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
