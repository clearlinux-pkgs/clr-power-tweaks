...
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/v213.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-213
cd %{_builddir}/clr-power-tweaks-213
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637084683
...
cp %{_builddir}/clr-power-tweaks-213/COPYING %{buildroot}/usr/share/package-licenses/clr-power-tweaks/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
