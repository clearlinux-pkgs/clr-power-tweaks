...
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/234.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-234
cd %{_builddir}/clr-power-tweaks-234
pushd ..
cp -a clr-power-tweaks-234 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735918528
