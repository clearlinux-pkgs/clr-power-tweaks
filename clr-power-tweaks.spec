...
Version  : 174
Release  : 115
URL      : http://localhost/cgit/projects/clr-power-tweaks/snapshot/clr-power-tweaks-174.tar.gz
Source0  : http://localhost/cgit/projects/clr-power-tweaks/snapshot/clr-power-tweaks-174.tar.gz
...
Requires: clr-power-tweaks-license
...
%prep
%setup -q -n clr-power-tweaks-174
...
export LANG=C
export SOURCE_DATE_EPOCH=1535064057
...
export SOURCE_DATE_EPOCH=1535064057
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/clr-power-tweaks
cp COPYING %{buildroot}/usr/share/doc/clr-power-tweaks/COPYING
%make_install
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/clr-power-tweaks/COPYING
