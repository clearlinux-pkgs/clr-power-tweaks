...
Source0  : https://github.com/clearlinux/clr-power-tweaks/archive/refs/tags/248.tar.gz
...
%prep
%setup -q -n clr-power-tweaks-248
cd %{_builddir}/clr-power-tweaks-248
pushd ..
cp -a clr-power-tweaks-248 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739813424
